    ...
    return (
        <div className="bg-white p-4 shadow w-full">
            <div className="flex flex-col md:flex-row items-center justify-between w-full space-y-4 md:space-y-0">
                <div
                    className="flex flex-col md:flex-row items-start w-full md:w-auto space-y-2 md:space-y-0 md:space-x-3">
                    <button
                    ...
                    {filterOptions.length > 0 && (
                        <div className="relative w-full md:w-auto">
                            <button
                                ...
                                className="bg-gray-200 text-black px-3 py-2 rounded w-full md:w-auto hover:bg-gray-300 flex items-center justify-between"
                            >
                                {filterName} <FontAwesomeIcon icon={faCaretDown} className="ml-1"/>
                            </button>
                            {showFilterDropdown && (
                                <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg z-10">
                ...
                <div
                    className="flex flex-col md:flex-row items-center space-y-2 md:space-x-3 w-full md:w-auto justify-end">
                    <button
